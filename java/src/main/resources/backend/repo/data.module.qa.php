...
class AdminModule {
  ...
  function query_add_newQuestion($platformName, $question, $questionType, $answer){
	return "INSERT INTO platform_qa(platformName, question, questionType, answer) VALUES ('".$platformName."','".$question."','".$questionType."','".$answer."');";
  }
  ...
  function query_view_questions($platformName,$limitStart,$limitEnd){
	return "SELECT * FROM platform_qa WHERE platformName='".$platformName."' LIMIT ".$limitStart.",".$limitEnd; 
  }
